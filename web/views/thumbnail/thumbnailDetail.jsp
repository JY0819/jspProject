	...
	<div class="outer">
		<table class="detail" align="center">
			...
			<tr>
				...
				<td>
					<button
						onclick="location.href='<%=request.getContextPath()%>/download.tn?num=<%=titleImg.getFid()%>'">다운로드</button>
				</td>
			</tr>
			<tr>
				<td>사진메모</td>
			...
			<tr>
				<td>
					<div class="detailImgArea">
						...
						<button
							onclick="location.href='<%=request.getContextPath()%>/download.tn?num=<%=detailImg1.getFid()%>'">다운로드</button>
					</div>
				</td>
				<td>
					<div class="detailImgArea">
						...
						<button
							onclick="location.href='<%=request.getContextPath()%>/download.tn?num=<%=detailImg2.getFid()%>'">다운로드</button>
					</div>
				</td>
				<td>
					<div class="detailImgArea">
						...
						<button
							onclick="location.href='<%=request.getContextPath()%>/download.tn?num=<%=detailImg3.getFid()%>'">다운로드</button>
					</div>
				</td>
			</tr>
		</table>
